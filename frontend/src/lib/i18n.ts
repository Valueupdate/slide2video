...
export const translations = {
  ja: {
    ...
    regenerateButton: "🔄 再生成する",
    regenerateNote: "同じPDFで言語・声・設定を変えて再生成できます",
    regenerateConfirm: "現在の動画はまだダウンロードされていません。ダウンロードせずに続けますか？",
    downloadedButton: "ダウンロード済み ✅",
    saveShareSection: "保存・共有",
    shareButton: "共有...",
  ...
  en: {
    ...
    progressFailed: "Failed to retrieve progress",
    ...
    regenerateConfirm: "The current video has not been downloaded yet. Continue without downloading?",
    downloadedButton: "Downloaded ✅",
    saveShareSection: "Save & Share",
    shareButton: "Share...",
