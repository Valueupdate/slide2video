...
| T-15 | YouTube アップロード（F-12） | OAuth 2.0 連携で直接アップロード | ✅ 完了 |
...
| ✅ | YouTube OAuth 転送機能実装（認証・アップロード・コールバック） | 2026-03-30 |
| ✅ | プライバシーポリシーページ作成（日英バイリンガル） | 2026-03-30 |
| ✅ | 利用規約ページ英語化（日英バイリンガル） | 2026-03-30 |
